...
class document_invoice_type(osv.osv):
    ...
    _columns = {
         ...
         'sri_authorization_validation':fields.boolean('SRI authorization', help='Indicates whether this type of document is or is not required to request an authorization for invoice number assigned by each supplier.',),          
         'sri_authorization_validation_owner':fields.boolean('SRI authorization owner', help='Indicates if this document will be linked to an authorization number assigned by the company.',),
