            ...
            for obj in objs:
                if obj.type == 'out_invoice':
                    ...
                    if values.get('automatic', False):
                        values['automatic_number'] = doc_obj.get_next_value_secuence(cr, uid, 'credit_note', False, company_id, obj.shop_id.id, obj.printer_id.id, 'account.invoice', 'number_credit_note_out', context)
